...
export async function handleUpdate(cita, res) {
    ...
    console.log("Actualizando evento...", bodyInformacion);
    const tokenResultado = await apiServiceGoogleCalendar({ method: "update", bodyInformacion });
    console.log("token actualizado:", tokenResultado);
